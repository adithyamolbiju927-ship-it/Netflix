...
import 'package:netfix/view/navigatorpage2.dart';

class Upcomingcontainer extends ConsumerWidget {
  const Upcomingcontainer({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final move = ref.watch(upcomingProvider);
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => Navigatepage2(movemodel: movies),
                    ),
                  );
                },
                child: Container(
